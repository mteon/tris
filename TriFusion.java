...
public class TriFusion<T extends Comparable> {
    ...
    public TriFusion(ArrayList<T> listToSort) {
        this.listToSort = listToSort;
    }

    public ArrayList<T> triFusion (ArrayList<T> list) {
        if (list.size() <= 1)
            return list;
        else {
            ArrayList<T> e1 = new ArrayList<>();
            ArrayList<T> e2 = new ArrayList<>();
    ...
    public ArrayList<T> fusion (ArrayList<T> e1, ArrayList<T> e2) {
        ArrayList<T> listSorted = new ArrayList<>();
